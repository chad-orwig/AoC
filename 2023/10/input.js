/**
 * @typedef {'east-west' | 'north-south' | 'north-east' | 'north-west' | 'south-east' | 'south-west' | 'empty' | 'start' } PipeType
 * @typedef { '-' | '|' | 'L' | 'J' | 'F' | '7' | '.' | 'S' } PipeSymbol
 * @type {{ [symbol: string]: PipeType}}
 */
export const pipeSymbolMap = {
  '-': 'east-west',
  '|': 'north-south',
  'L': 'north-east',
  'J': 'north-west',
...
export const input=`L-77.L-J7F.-7FFF77.F7-|7.7-F-7L--|-|-7-F|FL7FF|.7FF-L7LFJ77-J--|.F7.-FF--77..FLJ7.FFF.|7FF--F--7-.|J.FFJ-7.F-7-|-7F77..77L-L-|.F-7-|-F--L7F-
...
L7JJF-7L|-LFJ.L7J|J-|.JL7.F.-J-7LL|J-|-|-J-F.L-7-L|--.LJ-FJ-JJ.LLL.LLF|LL77.JJ.L-|JJLJLJ-F7J..L-LJJL7J-J..|-L--J-J-L7--JFL7-JF|-F77-FLJL-JLJ`
  .split('\n')
  .map(line => line.split(''))
  .flatMap((line, row) => line.map((symbol, col) => ({ symbol, col, row, type: pipeSymbolMap[symbol] })));

export const test = `.F----7F7F7F7F-7....
.|F--7||||||||FJ....
.||.FJ||||||||L7....
FJL7L7LJLJ||LJ.L-7..
L--J.L7...LJS7F-7L7.
