export const input=`fdb bgfa cedfg abedcf defgba gbaed dagfbce fbged dgabce fb | bf dfbega fb baged
...
function readLine(line) {
    ...
    const inputs = inputString.trim().split(' ').map(sortString);
    const outputs = outputString.trim().split(' ').map(sortString);
