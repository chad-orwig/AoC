...
const objectArray = inputArray.map(line => {
    const regexResults = regex.exec(line);
    return {
        register : regexResults[1],
        direction: regexResults[2],
        value    : Number(regexResults[3]),
        conditionRegister : regexResults[4],
        conditional : regexResults[5],
        conditionValue : Number(regexResults[6])
    };
});
